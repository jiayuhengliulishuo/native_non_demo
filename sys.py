...
print("\n\n\n\n\n\n\n\n:get score")
CMD="/data/jiayuheng/score/ALIZE_file_multithread/LIA_RAL/bin/ComputeTest --config ComputeTest.cfg --ndxFilename filename world2048_5_noWarning_native world2048_5_noWarning_non &> data/ComputeTest_noWarning_native.cfg"
